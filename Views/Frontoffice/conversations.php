...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar-logo i { color: #e70013; font-size: 1.2rem; }
        ...
        .sidebar-module-card {
            margin: 1.25rem 1rem;
            background: linear-gradient(135deg, rgba(37,99,235,.25) 0%, rgba(124,58,237,.2) 100%);
        ...
        .nav-item i { width: 18px; font-size: .95rem; text-align: center; flex-shrink: 0; }
        .nav-item:hover {
        ...
        .logo i { color: #e70013; font-size: 1.2rem; }
        .logo .logo-freela { font-size: 1.35rem; font-weight: 700; color: white; }
        .logo .logo-skill  { font-size: 1.35rem; font-weight: 700; color: var(--tech-blue); }
        ...
        .nav-link-btn:hover { background: rgba(37,99,235,.12); color: var(--tech-blue); border-color: rgba(37,99,235,.3); }
        .nav-link-btn.active { background: rgba(37,99,235,.15); color: var(--tech-blue); border-color: rgba(37,99,235,.35); }
...
<aside class="app-sidebar">
    ...
    <a class="nav-item active" href="index.php?page=conversations">
        <i class="fa-regular fa-comments"></i>
    ...
    <a class="nav-item" href="index.php?page=conversations&filter=active">
        <i class="fa-solid fa-circle" style="color:var(--tech-green);font-size:.55rem;"></i>
        Conversations actives
        <?php if ($activeConvs > 0): ?>
            <span class="nav-badge" style="background:rgba(34,197,94,.15);color:var(--tech-green);"><?= $activeConvs ?></span>
        <?php endif; ?>
    </a>
    <a class="nav-item" href="#" onclick="openGroupeModal(); return false;">
        <i class="fa-solid fa-people-group"></i>
        Créer un groupe
    </a>

    <div class="sidebar-nav-label" style="margin-top:.5rem;">Outils</div>

    <a class="nav-item" href="index.php?page=home">
        <i class="fa-solid fa-house"></i>
        Accueil
    </a>
    <a class="nav-item" href="index.php?page=missions">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            <div class="sidebar-user-av"><?= $currentUserId ?></div>
            <div>
                <div class="sidebar-user-name">Utilisateur #<?= $currentUserId ?></div>
                <div class="sidebar-user-role">
                    <span style="color:var(--tech-green);">●</span> En ligne
                </div>
            </div>
        </div>
    </div>
...
<div class="main-area">
    ...
    <nav class="navbar">
        <div class="navbar-right">
            <a href="index.php?page=conversations" class="nav-link-btn active">
                <i class="fa-regular fa-comments"></i> Messagerie
            </a>
            <a href="index.php?page=home" class="nav-link-btn">
    ...
    <div class="whatsapp-layout">
        ...
        <div class="conversations-sidebar" id="conversationsSidebar">
            <div class="sidebar-header">
                ...
                <form class="search-tri-form" method="GET" action="index.php" id="searchTriForm">
...
function clearSearch() {
    window.location.href = 'index.php?page=conversations&tri=<?= $currentTri ?>';
}
...
function renderChatArea(data) {
    ...
    chatArea.innerHTML = `
        <div class="chat-header">
            <div class="chat-header-avatar">${otherUser}</div>
...
function sendMessage() {
    ...
    fetch('index.php?page=chat&action=' + endpoint, {
        method: 'POST',
...
function refreshMessages() {
    ...
    fetch('get_messages.php?id=' + currentConversationId)
        .then(r => r.json())
        .then(data => {
...
function translateMessage(event, messageId, targetLang) {
    ...
    fetch('index.php?page=chat&action=translate', {
        method: 'POST',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
...
function handleFileUpload(event) {
    ...
    fetch('index.php?page=chat&action=upload-file', {
        method: 'POST',
        body: formData
    }).then(r => r.json()).then(data => {
...
function loadUnreadCounts() {
    fetch('index.php?page=chat&action=unread-counts')
        .then(r => r.json())
        .then(data => {
...
function renameConversation() {
    ...
    if (newName && newName.trim()) {
        fetch('index.php?page=chat&action=rename', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
...
function deleteCurrentConversation() {
    if (confirm('Supprimer cette conversation ?')) {
        fetch('index.php?page=chat&action=delete-conv-user', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
...
function submitGroupe() {
    ...
    fetch('index.php?page=chat&action=create-groupe', { method: 'POST', body: fd })
        .then(r => r.json())
...
function openGitPanel() {
    ...
    window.open('index.php?page=git&id_conversation=' + currentConversationId, '_blank', 'width=1100,height=750,resizable=yes,scrollbars=yes');
}
...
function startConversationByName(name) {
    fetch('index.php?page=chat&action=create', {
        method: 'POST',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
