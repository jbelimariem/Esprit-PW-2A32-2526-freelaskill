...
<div class="admin-layout">
    ...
    <aside class="sidebar">
        <div style="padding:0 0.5rem; margin-bottom:2rem;">
            ...
            <p style="font-size:.75rem; color:#475569; margin-top:.5rem; letter-spacing:1px;">Admin Control v1.0</p>
        </div>
        ...
        <a href="admin_freelancers.php" class="nav-item active" style="text-decoration:none;"><i class="fa-solid fa-user-tie"></i> Freelancers</a>

        <div class="nav-item-wrapper">
            <a href="dashboard.php" class="nav-item" style="text-decoration:none;">
                <i class="fa-solid fa-store"></i> Marketplace
                <i class="fa-solid fa-chevron-right" style="margin-left:auto; font-size:.7rem; opacity:.5;"></i>
            </a>
            <div class="submenu">
        ...
        <div class="nav-item" style="opacity:.5;cursor:default;"><i class="fa-solid fa-shield-halved"></i> Securite</div>
        <div class="nav-item" style="opacity:.5;cursor:default;"><i class="fa-solid fa-comments"></i> Messagerie</div>

        <div style="margin-top:auto; padding-top:2rem;">
            <a href="../frontoffice/home.php" class="btn btn-outline"
               style="width:100%;font-size:.85rem;padding:.75rem;border-radius:999px;display:flex;align-items:center;justify-content:center;gap:.5rem;color:#ef4444;border-color:rgba(239,68,68,.2);">
