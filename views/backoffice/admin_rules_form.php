...
<head>
    ...
    <title>Admin — <?php echo isset($currentRule) ? 'Modifier' : 'Ajouter'; ?> une Règle · FreelaSkill</title>
...
<main class="admin-main">
    ...
    <div class="admin-topbar animate-in">
        <div>
            <div class="admin-breadcrumb">
                ...
                <span class="sep">/</span>
                <a href="admin_rules_list.php">Règles</a>
                <span class="sep">/</span>
                <span class="current"><?php echo isset($currentRule) ? 'Modifier' : 'Ajouter'; ?></span>
            </div>
            <h1 class="admin-page-title"><?php echo isset($currentRule) ? 'Modifier la' : 'Nouvelle'; ?> <span>Règle</span></h1>
        </div>
        <div class="topbar-actions">
            <a href="admin_rules_list.php" class="btn btn-secondary">
    ...
    <form id="ruleForm" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'); ?>" novalidate>
        ...
        <div class="form-section animate-in delay-1">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label class="form-label">Titre de la règle <span class="required">*</span></label>
                ...
                <div class="form-group">
                    <label class="form-label">Type de clause <span class="required">*</span></label>
                ...
                <div class="form-group full">
                    ...
                    <textarea id="description" name="description" rows="4" class="form-textarea <?php echo isset($errors['description']) ? 'has-error' : ''; ?>"
                              placeholder="Décrivez précisément la règle et ses conditions d'application..."><?php echo htmlspecialchars($currentRule['description'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <?php if (isset($errors['titre_contrat'])): ?>
                        <span class="field-error"><?php echo htmlspecialchars($errors['titre_contrat'], ENT_QUOTES, 'UTF-8'); ?></span>
                    <?php endif; ?>
                </div>
        ...
        <div class="form-actions animate-in delay-2">
            <a href="admin_rules_list.php" class="btn btn-secondary" style="padding:0.9rem 2rem;">Annuler</a>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Nettoyer les données de règles suggérées au chargement
    document.getElementById('suggested-rules-data')?.remove();
});
</script>
</body>
</html>
