...
function buildAvatarWebPath($avatar)
{
...
// Only view own profile (or admin later)
...
$success  = false;
$profileResult = $userController->handleProfileActions($user, $success);
...
$roleBadge = $user->getRole() === 'freelancer'
...
if ($user->getStatus() === 'active') {
    $statusBadge = '<span class="badge badge-active"><i class="fa-solid fa-circle-check"></i> Actif</span>';
} elseif ($user->getStatus() === 'banned') {
    $statusBadge = '<span class="badge badge-banned"><i class="fa-solid fa-ban"></i> Suspendu</span>';
} else {
    $statusBadge = '<span class="badge badge-pending"><i class="fa-solid fa-clock"></i> En attente</span>';
}
$memberSince = date('d/m/Y', strtotime($user->getCreatedAt()));
$avatarUrl = buildAvatarWebPath($user->getAvatar() ?? '');
$hasAvatar = $avatarUrl !== '';
$activeProfileTab = 'info';

if ($profileAction === 'password') {
    $activeProfileTab = 'security';
} elseif (in_array($profileAction, ['links', 'files'], true)) {
    $activeProfileTab = 'networks';
}
?>
<!DOCTYPE html>
                    ...
                    <form method="POST" action="profile.php" style="display:flex;flex-direction:column;gap:1.25rem;" novalidate>
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
                            <div class="form-group">
                                ...
                                <input class="form-input<?php echo $fieldError($updateErrors, 'nom') !== '' ? ' input-error' : ''; ?>" type="text" id="nom" name="nom"
                                       value="<?php echo htmlspecialchars($_POST['nom'] ?? $user->getNom()); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-input<?php echo $fieldError($updateErrors, 'prenom') !== '' ? ' input-error' : ''; ?>" type="text" id="prenom" name="prenom"
                                       value="<?php echo htmlspecialchars($_POST['prenom'] ?? $user->getPrenom()); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-input<?php echo $fieldError($updateErrors, 'email') !== '' ? ' input-error' : ''; ?>" type="text" id="email" name="email"
                                   value="<?php echo htmlspecialchars($_POST['email'] ?? $user->getEmail()); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-input" id="bio" name="bio" rows="4"
                                      placeholder="Parlez-nous de vous…"><?php echo htmlspecialchars($_POST['bio'] ?? $user->getBio() ?? ''); ?></textarea>
                        </div>
        ...
        <div class="tab-panel" id="panel-activity">
            <div class="section-card">
                ...
                <div class="section-card-body">
                    ...
                    <?php if (isset($_SESSION['pwd_changed_time'])): ?>
                    <div class="activity-item">
