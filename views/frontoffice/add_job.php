    ...
    <div class="products-area" style="padding-right:0; max-width:860px; margin:0 auto; width:100%;">
        ...
        <div class="product-card" style="opacity:1; box-shadow:0 10px 40px rgba(0,0,0,0.3);">
            <div class="card-body" style="padding:2.5rem;">
                <form id="add-form" action="add_job.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" rows="6"
                                  ...
                                  placeholder="Décrivez en détail votre mission : contexte, objectifs, livrables attendus, conditions de travail..."><?= htmlspecialchars($data['description']) ?></textarea>
