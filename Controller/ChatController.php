...
class ChatController {
    ...
    public function conversations() {
        ...
        $unread_count = 0;
        include __DIR__ . '/../Views/Frontoffice/conversations.php';
    }
    ...
    public function show(int $id_conversation) {
        ...
        include __DIR__ . '/../Views/Frontoffice/chat.php';
    }
...
if (!$directAccess && !$groupeAccess) {
    ...
    public function createConversation() {
        ...
        try {
            ...
            ");
            $ok = $stmt->execute([':u1' => $id_user1, ':u2' => $id_user2, ':titre' => $titre]);
            if ($ok) {
    ...
    try {
        // id_user2 = 0 pour indiquer que c'est un groupe
        $stmt = $this->pdo->prepare("
            INSERT INTO conversations (id_user1, id_user2, statut, titre, date_creation)
            VALUES (:u1, 0, 'active', :titre, NOW())
        ");
